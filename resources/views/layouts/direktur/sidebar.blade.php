...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-list" style="margin-top: auto;">
      ...
      <li>
        <a href="{{ route('direktur.pengajuan-cuti.index') }}">
      ...
      <li>
        <a href="{{ route('direktur.pengajuan-kasbon.index') }}">
        ...
        <li>
          <a href="{{ route('direktur.pengajuan-barang.index') }}">
        ...
        <li>
          <a href="{{ route('direktur.approve.cuti') }}">
        ...
        <li>
          <a href="/direktur/approve/barang">
        ...
        <li>
          <a href="/direktur/approve/kasbon">
            <i class='bx bx-money' ></i>
