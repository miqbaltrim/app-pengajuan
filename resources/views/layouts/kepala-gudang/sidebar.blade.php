...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-list" style="margin-top: auto;">
      <li>
        <a href="/kepala-gudang/dashboard">
      ...
      <li>
        <a href="{{ route('kepala-gudang.pengajuan-cuti.index') }}">
      ...
      <li>
        <a href="{{ route('kepala-gudang.pengajuan-kasbon.index') }}">
        ...
        <li>
          <a href="{{ route('kepala-gudang.pengajuan-barang.index') }}">
        ...
        <li>
          <a href="{{ route('kepala-gudang.approve.cuti') }}">
        ...
        <li>
          <a href="/kepala-gudang/approve/barang">
        ...
        <li>
          <a href="/kepala-gudang/approve/kasbon">
            <i class='bx bx-money' ></i>
