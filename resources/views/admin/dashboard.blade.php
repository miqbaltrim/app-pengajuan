...
<div class="content-wrapper" id="contentWrapper">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="grid-item">
        <!-- Grid sebelah kiri 3 -->
        <h3 class="fixed-title">Buat Pengumuman</h3>
        ...
        <div class="social-feed">
            ...
            <div class="social-feed-item">
                ...
                <div class="post-caption">
                    @php
                    $caption = $pengumuman->caption;
                    $wordCount = str_word_count($caption);
                    if ($wordCount > 20) {
                        $caption = implode(' ', array_slice(explode(' ', $caption), 0, 20)) . '...';
                    }
                    @endphp
                    <p>{{ $caption }}</p>
                </div>
                <!-- Tombol Hapus untuk setiap pengumuman -->
                <div class="ml-auto">
                    <form action="{{ route('admin.delete_announcement', $pengumuman->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
            ...
            @endforeach
            <form action="{{ route('admin.post_announcement') }}" method="POST" enctype="multipart/form-data">
              @csrf
