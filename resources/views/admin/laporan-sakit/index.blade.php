        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title">Laporan Sakit Karyawan</h5>
                    <div class="ml-auto">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <form action="{{ route('admin.laporan-sakit.search') }}" method="POST" class="form-inline">
                            @csrf
                            ...
                            <a href="{{ route('admin.laporan-sakit.riwayat') }}" class="btn btn-custom-orange mb-2">Riwayat Sakit</a>
                            <a href="{{ route('admin.approve.sakit') }}" class="btn btn-success mb-2">Approve Sakit</a>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive" id="printableTable">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach($laporanSakit as $laporan)
                                <tr>
