                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.approve.barang.detailBarang', ['id' => $pengajuan->id]) }}" class="btn btn-info btn-sm">Detail</a>
                                        @php
                                        ...
                                        @if($disetujuiOleh === $userRole && $pengajuan->setujui === 'tunggu')
                                            <form action="{{ route('direktur.approve.barang.disetujui-terima', ['id' => $pengajuan->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                <button type="submit" class="btn btn-success btn-sm">Setujui</button>
                                            </form>
                                            <form action="{{ route('direktur.approve.barang.disetujui-tolak', ['id' => $pengajuan->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                        ...
                                        @if($diketahuiOleh === $userRole && $pengajuan->ketahui === 'tunggu')
                                            <form action="{{ route('direktur.approve.barang.diketahui-terima', ['id' => $pengajuan->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                <button type="submit" class="btn btn-info btn-sm">Ketahui</button>
                                            </form>
                                            <form action="{{ route('direktur.approve.barang.diketahui-tolak', ['id' => $pengajuan->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                <button type="submit" class="btn btn-danger btn-sm">Tolak</button>
                                            </form>
                                        @endif
