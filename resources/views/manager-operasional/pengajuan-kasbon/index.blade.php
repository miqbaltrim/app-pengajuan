    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('manager-operasional.pengajuan-kasbon.create') }}" class="btn btn-success mb-3">Buat Kasbon</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($kasbon->setujui == 'diterima' && $kasbon->ketahui == 'diterima')
                                                <a href="{{ route('manager-operasional.pengajuan-kasbon.download', $kasbon->id) }}" class="btn btn-success btn-sm">Download</a>
                                            @else
                                                <a href="{{ route('manager-operasional.pengajuan-kasbon.edit', $kasbon->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                <form action="{{ route('manager-operasional.pengajuan-kasbon.destroy', $kasbon->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
