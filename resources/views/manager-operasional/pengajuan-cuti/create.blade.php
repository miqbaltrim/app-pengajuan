        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="/manager-operasional/pengajuan-cuti" class="btn btn-danger">Back</a> <!-- Back button -->
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('manager-operasional.pengajuan-cuti.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
