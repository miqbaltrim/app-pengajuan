    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('manager-operasional.pengajuan-barang.create') }}" class="btn btn-success mb-3">Buat Pengajuan</a>
                                ...
                                @foreach($pengajuans as $pengajuan)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('manager-operasional.pengajuan-barang.edit', $pengajuan->id) }}" class="btn btn-primary btn-sm">Edit</a>

                                            <!-- Tambahkan formulir hapus -->
                                            <form action="{{ route('manager-operasional.pengajuan-barang.destroy', $pengajuan->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            @if($pengajuan->setujui === 'diterima' && $pengajuan->ketahui === 'diterima')
                                                <a href="{{ route('manager-operasional.pengajuan-barang.download-surat', $pengajuan->id) }}" class="btn btn-info btn-sm">Download Surat</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
