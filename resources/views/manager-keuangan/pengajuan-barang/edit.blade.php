        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($pengajuan->barangs as $barang)
                                    <tr>
                                        ...
                                        <td>{{ $barang->total }}</td>
                                        <td>
                                            <form action="{{ route('manager-keuangan.pengajuan-barang.delete-item', ['id' => $pengajuan->id, 'item_id' => $barang->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <form action="{{ route('manager-keuangan.pengajuan-barang.update', $pengajuan->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
