        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('manager-keuangan.pengajuan-cuti.index') }}" class="btn btn-danger">Back</a>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('manager-keuangan.pengajuan-cuti.update', $ajucuti->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
