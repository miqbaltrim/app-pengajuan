...
class DashboardControllerDR extends Controller
{
...
$notifikasiPengajuan = Pengajuan::where('setujui', 'diterima')
    ...
    ->get();
        ...
        // Menampilkan view dashboard.blade.php di dalam direktori direktur
        return view('direktur.dashboard', compact('riwayatCuti', 'notifikasiPengajuan', 'pengumumans'));
    }
