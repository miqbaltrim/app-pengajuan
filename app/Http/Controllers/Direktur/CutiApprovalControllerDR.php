...
class CutiApprovalControllerDR extends Controller
{
    public function index()
    {
        ...
        // Menampilkan view approve/cuti.blade.php di dalam direktori direktur
        return view('direktur.approve.cuti', compact('ajucutis'));
    }
