...
class BarangApprovalControllerDR extends Controller
{
    public function index()
    {
        ...
        return view('direktur.approve.barang', compact('pengajuanBarang'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('direktur.approve.detailBarang', compact('pengajuan'));
    }
