...
class CutiApprovalControllerHR extends Controller
{
    public function index()
    {
        ...
        // Menampilkan view approve/cuti.blade.php di dalam direktori admin
        return view('admin.approve.cuti', compact('ajucutis', 'riwayatCutis'));
    }
