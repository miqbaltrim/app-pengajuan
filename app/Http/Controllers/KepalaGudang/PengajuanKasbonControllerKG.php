...
class PengajuanKasbonControllerKG extends Controller
{
    public function index()
    {
        ...
        return view('kepala-gudang.pengajuan-kasbon.index', compact('kasbons'));
    }
    ...
    public function create()
    {
        ...
        return view('kepala-gudang.pengajuan-kasbon.create', compact('user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kepala-gudang.pengajuan-kasbon.index')->with('success', 'Kasbon berhasil dibuat.');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('kepala-gudang.pengajuan-kasbon.edit', compact('kasbon'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('kepala-gudang.pengajuan-kasbon.index')->with('success', 'Kasbon berhasil diperbarui.');
}
    ...
    public function destroy($id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('kepala-gudang.pengajuan-kasbon.index')->with('success', 'Kasbon berhasil dihapus.');
    }
