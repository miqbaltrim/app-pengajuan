...
class PengajuanCutiControllerKG extends Controller
{
    ...
    // Menampilkan view index.blade.php di dalam direktori kepala-gudang/pengajuan-cuti
    return view('kepala-gudang.pengajuan-cuti.index', compact('ajucutis', 'totalCuti'));
}
public function reset()
{
    ...
    try {
        ...
        return redirect()->route('kepala-gudang.pengajuan-cuti.index')->with('success', 'Jumlah cuti berhasil direset.');
    } catch (\Exception $e) {
    ...
    public function riwayatDashboard()
    {
        ...
        // Menampilkan view index.blade.php di dalam direktori kepala-gudang/pengajuan-cuti
        return view('kepala-gudang.dashboard', compact('riwayatCuti'));
    }

    public function create()
    {
        return view('kepala-gudang.pengajuan-cuti.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Redirect dengan pesan sukses
            return redirect()->route('kepala-gudang.pengajuan-cuti.index')->with('success', 'Pengajuan cuti berhasil diajukan.');
        } catch (\Exception $e) {
            // Rollback transaksi jika terjadi kesalahan dan tangani kesalahan
            DB::rollback();
            // Tangani kesalahan
    ...
    public function edit($id)
    {
        ...
        // Menampilkan view edit.blade.php di dalam direktori kepala-gudang/pengajuan-cuti
        return view('kepala-gudang.pengajuan-cuti.edit', compact('ajucuti'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    try {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('kepala-gudang.pengajuan-cuti.index')->with('success', 'Pengajuan cuti berhasil diperbarui.');
    } catch (\Exception $e) {
        // Rollback transaksi jika terjadi kesalahan dan tangani kesalahan
        DB::rollback();
        // Tangani kesalahan
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kepala-gudang.pengajuan-cuti.index')->with('success', 'Data pengajuan cuti berhasil dihapus.');
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        if (in_array(Auth::user()->role, ['direktur', 'manager-operasional', 'manager-territory', 'manager-keuangan', 'area-manager', 'kepala-cabang', 'kepala-gudang']) && $ajucuti->status == 'pending') {
            ...
            return redirect()->route('kepala-gudang.pengajuan-cuti.index')->with('success', 'Pengajuan cuti berhasil disetujui.');
        }

        // Jika pengguna tidak memiliki hak atau pengajuan cuti tidak dalam status pending, redirect kembali dengan pesan error
        return redirect()->route('kepala-gudang.pengajuan-cuti.index')->with('error', 'Anda tidak memiliki izin untuk menyetujui pengajuan cuti ini.');
    }
