...
class BarangApprovalControllerKG extends Controller
{
    public function index()
    {
        ...
        return view('kepala-gudang.approve.barang', compact('pengajuanBarang'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('kepala-gudang.approve.detailBarang', compact('pengajuan'));
    }
