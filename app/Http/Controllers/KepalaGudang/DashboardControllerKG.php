...
class DashboardControllerKG extends Controller
{
...
$notifikasiPengajuan = Pengajuan::where('setujui', 'diterima')
    ...
    ->get();
        ...
        // Menampilkan view dashboard.blade.php di dalam direktori kepala-gudang
        return view('kepala-gudang.dashboard', compact('riwayatCuti', 'notifikasiPengajuan', 'pengumumans'));
    }
