...
class DashboardControllerAM extends Controller
{
    public function index()
    {
        ...
        // Menampilkan view dashboard.blade.php di dalam direktori area-manager
        return view('area-manager.dashboard', compact('riwayatCuti', 'notifikasiPengajuan', 'pengumumans'));
    }
