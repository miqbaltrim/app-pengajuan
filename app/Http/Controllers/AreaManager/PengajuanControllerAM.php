...
class PengajuanControllerAM extends Controller
{
    public function index()
{
    ...
    return view('area-manager.pengajuan-barang.index', compact('pengajuans'));
}
    ...
    public function notifikasiPengajuan()
{
    ...
    // Kirim data ke view
    return view('area-manager.notifikasi-pengajuan', compact('notifikasiPengajuan'));
}
    ...
    public function create()
    {
        ...
        return view('area-manager.pengajuan-barang.create', compact('nextReferenceNumber'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $diketahuiOlehUser = User::where('role', $request->diketahui_oleh)->firstOrFail();
            ...
            return redirect()->route('area-manager.pengajuan-barang.index')->with('success', 'Pengajuan berhasil ditambahkan.');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('area-manager.pengajuan-barang.edit', compact('pengajuan'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('area-manager.pengajuan-barang.index')->with('success', 'Pengajuan berhasil diperbarui.');
    } catch (\Exception $e) {
        // Rollback transaksi jika terjadi kesalahan
        DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('area-manager.pengajuan-barang.index')->with('success', 'Pengajuan berhasil dihapus.');
    }
