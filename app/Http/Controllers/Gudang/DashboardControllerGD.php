...
class DashboardControllerGD extends Controller
{
...
$notifikasiPengajuan = Pengajuan::where('setujui', 'diterima')
    ...
    ->get();
        ...
        // Menampilkan view dashboard.blade.php di dalam direktori gudang
        return view('gudang.dashboard', compact('riwayatCuti', 'notifikasiPengajuan', 'pengumumans'));
    }
