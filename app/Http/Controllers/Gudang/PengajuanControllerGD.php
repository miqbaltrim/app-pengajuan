...
class PengajuanControllerGD extends Controller
{
    public function index()
{
    ...
    return view('gudang.pengajuan-barang.index', compact('pengajuans'));
}
    ...
    public function notifikasiPengajuan()
{
    ...
    // Kirim data ke view
    return view('gudang.notifikasi-pengajuan', compact('notifikasiPengajuan'));
}
    ...
    public function create()
    {
        ...
        return view('gudang.pengajuan-barang.create', compact('nextReferenceNumber'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $diketahuiOlehUser = User::where('role', $request->diketahui_oleh)->firstOrFail();
            ...
            return redirect()->route('gudang.pengajuan-barang.index')->with('success', 'Pengajuan berhasil ditambahkan.');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('gudang.pengajuan-barang.edit', compact('pengajuan'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('gudang.pengajuan-barang.index')->with('success', 'Pengajuan berhasil diperbarui.');
    } catch (\Exception $e) {
        // Rollback transaksi jika terjadi kesalahan
        DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('gudang.pengajuan-barang.index')->with('success', 'Pengajuan berhasil dihapus.');
    }
