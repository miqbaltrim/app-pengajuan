...
class PengajuanControllerMO extends Controller
{
    public function index()
{
    ...
    return view('manager-operasional.pengajuan-barang.index', compact('pengajuans'));
}
    ...
    public function notifikasiPengajuan()
{
    ...
    // Kirim data ke view
    return view('manager-operasional.notifikasi-pengajuan', compact('notifikasiPengajuan'));
}
    ...
    public function create()
    {
        ...
        return view('manager-operasional.pengajuan-barang.create', compact('nextReferenceNumber'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $diketahuiOlehUser = User::where('role', $request->diketahui_oleh)->firstOrFail();
            ...
            return redirect()->route('manager-operasional.pengajuan-barang.index')->with('success', 'Pengajuan berhasil ditambahkan.');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('manager-operasional.pengajuan-barang.edit', compact('pengajuan'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('manager-operasional.pengajuan-barang.index')->with('success', 'Pengajuan berhasil diperbarui.');
    } catch (\Exception $e) {
        // Rollback transaksi jika terjadi kesalahan
        DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manager-operasional.pengajuan-barang.index')->with('success', 'Pengajuan berhasil dihapus.');
    }
