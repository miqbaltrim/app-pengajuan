...
class PengajuanCutiControllerMO extends Controller
{
    ...
    // Menampilkan view index.blade.php di dalam direktori manager-operasional/pengajuan-cuti
    return view('manager-operasional.pengajuan-cuti.index', compact('ajucutis', 'totalCuti'));
}
public function reset()
{
    ...
    try {
        ...
        return redirect()->route('manager-operasional.pengajuan-cuti.index')->with('success', 'Jumlah cuti berhasil direset.');
    } catch (\Exception $e) {
    ...
    public function riwayatDashboard()
    {
        ...
        // Menampilkan view index.blade.php di dalam direktori manager-operasional/pengajuan-cuti
        return view('manager-operasional.dashboard', compact('riwayatCuti'));
    }

    public function create()
    {
        return view('manager-operasional.pengajuan-cuti.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Redirect dengan pesan sukses
            return redirect()->route('manager-operasional.pengajuan-cuti.index')->with('success', 'Pengajuan cuti berhasil diajukan.');
        } catch (\Exception $e) {
            // Rollback transaksi jika terjadi kesalahan dan tangani kesalahan
            DB::rollback();
            // Tangani kesalahan
    ...
    public function edit($id)
    {
        ...
        // Menampilkan view edit.blade.php di dalam direktori manager-operasional/pengajuan-cuti
        return view('manager-operasional.pengajuan-cuti.edit', compact('ajucuti'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    try {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('manager-operasional.pengajuan-cuti.index')->with('success', 'Pengajuan cuti berhasil diperbarui.');
    } catch (\Exception $e) {
        // Rollback transaksi jika terjadi kesalahan dan tangani kesalahan
        DB::rollback();
        // Tangani kesalahan
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manager-operasional.pengajuan-cuti.index')->with('success', 'Data pengajuan cuti berhasil dihapus.');
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        if (in_array(Auth::user()->role, ['direktur', 'manager-operasional', 'manager-territory', 'manager-keuangan', 'area-manager', 'kepala-cabang', 'kepala-gudang']) && $ajucuti->status == 'pending') {
            ...
            return redirect()->route('manager-operasional.pengajuan-cuti.index')->with('success', 'Pengajuan cuti berhasil disetujui.');
        }

        // Jika pengguna tidak memiliki hak atau pengajuan cuti tidak dalam status pending, redirect kembali dengan pesan error
        return redirect()->route('manager-operasional.pengajuan-cuti.index')->with('error', 'Anda tidak memiliki izin untuk menyetujui pengajuan cuti ini.');
    }
