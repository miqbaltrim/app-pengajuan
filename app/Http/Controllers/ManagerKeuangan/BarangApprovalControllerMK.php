...
class BarangApprovalControllerMK extends Controller
{
    public function index()
    {
        ...
        return view('manager-keuangan.approve.barang', compact('pengajuanBarang'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('manager-keuangan.approve.detailBarang', compact('pengajuan'));
    }
