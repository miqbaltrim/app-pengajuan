...
class CutiApprovalControllerMK extends Controller
{
    public function index()
    {
        // Pastikan pengguna memiliki peran sebagai area manager
        if (!Auth::user()->hasRole('manager-keuangan')) {
        ...
        // Menampilkan view approve/cuti.blade.php di dalam direktori manager-keuangan
        return view('manager-keuangan.approve.cuti', compact('ajucutis'));
    }
