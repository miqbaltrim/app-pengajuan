...
class DashboardControllerMK extends Controller
{
    public function index()
    {
        ...
        // Menampilkan view dashboard.blade.php di dalam direktori manager-keuangan
        return view('manager-keuangan.dashboard', compact('riwayatCuti', 'notifikasiPengajuan', 'pengumumans'));
    }
